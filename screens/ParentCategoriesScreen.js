...
export default class ParentCategoriesScreen extends React.Component {
  ...
  componentDidMount() {
    return fetch('https://maturan.co/api/product')
              ...
              renderItem={({ item, index }) => (
                ...
                >
                  <View style={styles.imageCategoryContainer}>
                    <Image style={styles.imageCategoryItem} source={{ uri: item.photomainpath }} />
                  </View>
                  <View style={styles.infoCategoryItemContainer}>
                    <View>
                      <Text style={styles.titleCategoryTextStyle}>{item.categoryname}</Text>
                    </View>
