...
class HomeScreen extends React.Component {
  ...
  componentDidMount() {
    return fetch('https://maturan.co/v1/api/product/')
  ...
  render() {
    ...
    //    produkDataAlat = this.state.dataSource.map((value, index) => {
    //     let gambarArr = '';
    //     if (value) {
    //       //convert delimited string into array
    //       gambarArr = value.photomainpath.split(';').map((item, index) => {
    //         //console.log("\n value of gambar: "+item)
    //         let gbr = item.replace("\"", "")
    //         return gbr
    //       });
    //     }
    //     //replace value of gambar from String to Array
    //     value.photomainpath = gambarArr;

    //     //console.log("\n value:" + JSON.stringify(value));
    //     return value
    //   })
    //   this.setState.dataSource = produkDataAlat
    // }
